...
object MainData {
  ...
  val item4: Item = Item(10.0, 5.0, 1.0, product4)
  ...
  val order3: Order = Order("Client 3", "++351 999999998", "Address 2", 2.0, date20190101, List(item4))

  val ordersList: List[Order] = List(order1, order2, order3)
