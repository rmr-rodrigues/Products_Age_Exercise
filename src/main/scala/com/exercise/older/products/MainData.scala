...
object MainData {
  ...
  val product9: Product = Product("Product1", "Category1", 2.5f, 5.0, date20190131)
  val product10: Product = Product("Product2", "Category1", 2.5f, 5.0, date20180201)
  val product11: Product = Product("Product3", "Category1", 2.5f, 5.0, date20180602)
  val product12: Product = Product("Product4", "Category1", 2.5f, 5.0, date20181231)
  val product13: Product = Product("Product1", "Category1", 2.5f, 5.0, date20180501)
  ...
  val itemDate20190131: Item = Item(10.0, 5.0, 1.0, product9)
